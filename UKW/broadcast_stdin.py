...
# Title: Broadcast Stdin
# Generated: Sat Oct  8 19:06:52 2016
##################################################
...
class broadcast_stdin(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Broadcast Stdin")

        ##################################################
        # Variables
        ##################################################
        self.samp_rate = samp_rate = int(1e6)
        self.base_freq = base_freq = 93.8e6
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_short*1, '/dev/stdin', True)
...
def main(top_block_cls=broadcast_stdin, options=None):
