...
# Title: Top Block
# Generated: Fri Nov  4 23:28:48 2016
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._base_freq_range = Range(100e6, 850e6, 0.1e6, 400e6, 200)
        self._base_freq_win = RangeWidget(self._base_freq_range, self.set_base_freq, "base_freq", "counter_slider", float)
        self.top_layout.addWidget(self._base_freq_win)
        self.rational_resampler_xxx_0 = filter.rational_resampler_ccc(
                interpolation=int(samp_rate),
                decimation=2*int(audio_samp_rate),
                taps=None,
                fractional_bw=None,
        )
        ...
        self._audio_amp_range = Range(0, 1, 0.05, 0.1, 200)
        ...
        self.analog_wfm_tx_0 = analog.wfm_tx(
        	...
        	quad_rate=2*int(audio_samp_rate),
        	tau=75e-6,
        	max_dev=30e3,
        	fh=-1.0,
        )
        self.analog_sig_source_x_0 = analog.sig_source_f(audio_samp_rate, analog.GR_COS_WAVE, 0, 0, 0)
