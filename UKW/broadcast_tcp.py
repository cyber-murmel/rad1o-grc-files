...
# Title: Broadcast Tcp
# Generated: Sat Oct  8 19:18:30 2016
##################################################
...
class broadcast_tcp(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Broadcast Tcp")
        ...
        self.connect((self.blks2_tcp_source_0, 0), (self.blocks_short_to_float_0, 0))    
...
def main(top_block_cls=broadcast_tcp, options=None):
