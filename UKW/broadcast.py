...
# Title: Broadcast
# Generated: Sat Sep  3 16:41:57 2016
##################################################
...
class broadcast(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Broadcast")

        ##################################################
        # Variables
        ##################################################
        self.samp_rate = samp_rate = int(1e6)
        self.base_freq = base_freq = 100.5e6
        ...
        self.blocks_udp_source_0 = blocks.udp_source(gr.sizeof_short*1, "127.0.0.1", 1337, int(10e6), True)
...
def main(top_block_cls=broadcast, options=None):
